...
public class Camera2GLSurfaceViw extends GLSurfaceView implements GLSurfaceView.Renderer,
    ...
    public Camera2GLSurfaceViw(Context context) {
        this(context, null);
    }

    public Camera2GLSurfaceViw(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
